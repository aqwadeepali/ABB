...
HIGH_PATH = str(os.path.realpath(__file__))
HIGH_PATH = HIGH_PATH.replace("highcharts.pyc", "")
HIGH_PATH = HIGH_PATH.replace("highcharts.pyo", "")
HIGH_PATH = HIGH_PATH.replace("highcharts.py", "")
...
class Highchart(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.JSsource = [
                ...
                HIGH_PATH + "jquery.min.js",
                HIGH_PATH + "highcharts.js",
                HIGH_PATH + "highcharts-more.js",
                HIGH_PATH + "heatmap.js",
                HIGH_PATH + "exporting.js"
            ]

        # set CSS src
        self.CSSsource = [
                # 'https://www.highcharts.com/highslide/highslide.css',
                HIGH_PATH + "highslide.css"
