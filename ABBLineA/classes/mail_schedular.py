...
def set_settings(val):
    ...
    myquery = { "Field": "TIME_FLAG" }
    newvalues = { "$set": { "Value": val } } 
    
    db.update_one(myquery, newvalues)
    log.info("Setting Flag Done...%s", str(val))
...
def job():
    try:
        ...
        if current_time in sch_time_list and TIME_FLAG in [False, "False"]:
            ...
            email_client.sendMail('Britannia Report Line A', email_message)
            log.info("Email Sent...")
            ...
            #                 '<br>'\
            #                 '<br>'\
            #                 'Pls. find herewith the Dashboards for Britannia, Pondicherry Line B. <br>'\
            #                 '<br>'\
            #                 '<br>'\
            #                 'Regards, <br>'\
            #                 'Britannia Industries Limited. <br>'\
            #                 'Pondicherry, Line B.<br>'\
            #                 '<br>'\
            #                 '<br>'\
            #                 '* This is an auto generated Mail from BIT, Pondicherry, Line B. Please do not reply.*</p></body></html>'
            # email_client.sendMail('Britannia Dashboards Line B', email_message)
            # log.info("Email Sent...")
