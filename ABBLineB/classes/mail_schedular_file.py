...
with open("C:\mailer.log", "a") as fp:
    fp.write("Mailer script got executed 1a.\n")
...
with open("C:\mailer.log", "a") as fp:
    fp.write("Mailer script got executed 1b.\n")
try:
...
with open("C:\mailer.log", "a") as fp:
    fp.write("Mailer script got executed 1ba.\n")

from stage_moulder_data import MRun

with open("C:\mailer.log", "a") as fp:
    fp.write("Mailer script got executed 1bb.\n")

from stage_cms_data import CMSRun

with open("C:\mailer.log", "a") as fp:
    fp.write("Mailer script got executed 1bc.\n")

from stage_wet_weight_data import WWRun
with open("C:\mailer.log", "a") as fp:
    fp.write("Mailer script got executed 1bd.\n")

from stage_packing_data import PRun
with open("C:\mailer.log", "a") as fp:
    fp.write("Mailer script got executed 1be.\n")
from stage_oven_data import ORun
with open("C:\mailer.log", "a") as fp:
    fp.write("Mailer script got executed 1bf.\n")
from stage_bori_data import BRun
# import send_mail

with open("C:\mailer.log", "a") as fp:
    fp.write("Mailer script got executed 1c.\n")

from send_mail import EmailClient

with open("C:\mailer.log", "a") as fp:
    fp.write("Mailer script got executed 1d.\n")

import webbrowser
import ast

with open("C:\mailer.log", "a") as fp:
    fp.write("Mailer script got executed 2.\n")
...
with open("C:\mailer.log", "a") as fp:
    fp.write("Mailer script got executed 3.\n")

log = logging.getLogger()
logfile = os.path.abspath(LOG_PATH + "mailschedularlogs.log")
log.setLevel(INFO)
...
with open("C:\mailer.log", "a") as fp:
    fp.write("Mailer script got executed 4.\n")
