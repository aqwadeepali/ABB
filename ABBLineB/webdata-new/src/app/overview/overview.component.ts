...
export class OverviewComponent implements OnInit {
    ...
    public searchMixing: string;
  	...
  	ngOnInit() {
  		// let dateTime = "2019-09-25 20:01:00";
    ...
    private read_settings(): void {
        this.apiService.postapi("readsettings", {}).subscribe(d => {
            ...
            // setInterval(() => {
            //     let dt = new Date();
            //     let dtime = dt.getHours() + ":" + dt.getMinutes();
            //     console.log(dtime);
            //     // this.saveTimeout = "12:20";
            //     if(dtime === this.saveTimeout){
            //         this.all_dashboards = [];
            //         if(this.tileToShow["Mixing"] === true){
            ...
            //             this.sideBarVisibility = false;
            //             setTimeout(() => {
            //                 this.downloadSchedularFile();
            //             },8000);
            //         }
                    
            //         setTimeout(() => {
            //             if(this.tileToShow["Moulder"] === true){
            //                 console.log("Starting Moulder");
            //                 this.title = "Moulder - Overview";
            //                 this.subtitle = "Overview";
            //                 this.selected_tile = "Moulder";
            //                 this.overviewClicked('Moulder'); 
            ...
            //                     setTimeout(() => {
            //                         if(this.tileToShow["Wet Weight"] === true){
            //                             console.log("Starting Wet Weight");
            //                             this.title = "Wet Weight - Overview";
            //                             this.subtitle = "Overview";
            //                             this.selected_tile = "Wet Weight";
            //                             this.overviewClicked('Wet Weight'); 
            ...
            //                         setTimeout(() => {
            //                             if(this.tileToShow["Losses"] === true){
            //                                 console.log("Starting Losses");
            //                                 this.title = "Losses - Overview";
            //                                 this.subtitle = "Overview";
            //                                 this.selected_tile = "Losses";
            //                                 this.overviewClicked('Losses'); 
            ...
            //                             setTimeout(() => {
            //                                 if(this.tileToShow["Packing"] === true){
    ...
    // public downloadSchedularFile(): void {
    //     this.mask = true;
    ...
    //             element = '#mouldernodeToRenderAsPDF';
    //         }
    //         if(this.selected_tile === "Oven"){
    //             element = '#ovennodeToRenderAsPDF';
    //         }
    ...
    //             element = '#packingnodeToRenderAsPDF';
    //         }

    //         if(this.selected_tile === this.lastElement){            
    //             this.downloadPDF(element, "callback");
    //         }
    //         else{
    ...
    public downloadCMSOverview(): void {
        this.disableDownload = true;
        let params = {
            "selectedDate": this.fromDate.value,
            "selectedFromDate": this.fromDate.value,
        ...
        this.apiService.postapi("savecmshome", params).subscribe(d => {
            this.apiService.download(d.Results);
            this.mask = false;
            this.disableDownload = false;
        });
